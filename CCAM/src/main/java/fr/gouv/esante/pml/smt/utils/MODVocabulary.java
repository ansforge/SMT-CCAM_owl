...
public enum MODVocabulary implements HasShortForm, HasIRI, HasPrefixedName {
//@formatter:off
    /** browsingUI.         */ browsingUI            ("browsingUI",            ANNOTATION_PROPERTY),
    /** byteSize.         */ byteSize            ("byteSize",            ANNOTATION_PROPERTY),
    /** group.         */ group            ("group",            ANNOTATION_PROPERTY),
    /** vocabularyUsed.         */ vocabularyUsed            ("vocabularyUsed",            ANNOTATION_PROPERTY),
    /** hierarchyProperty.         */ hierarchyProperty            ("hierarchyProperty",            ANNOTATION_PROPERTY),
    /** obsoleteParent.         */ obsoleteParent            ("obsoleteParent",            ANNOTATION_PROPERTY),
    /** prefLabelProperty.         */ prefLabelProperty            ("prefLabelProperty",            ANNOTATION_PROPERTY),
...
//@formatter:on
  ...
  MODVocabulary(final String localname, final EntityType<?> entityType) {
    this.localName = localname;
    this.prefixedName = NameSpace.MOD.getPrefixName() + ':' + localname;
    this.entityType = entityType;
    this.iri = IRI.create(NameSpace.MOD.toString(), localname);
  }

  private static Stream<MODVocabulary> stream() {
