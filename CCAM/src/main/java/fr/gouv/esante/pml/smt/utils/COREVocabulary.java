...
public enum COREVocabulary implements HasShortForm, HasIRI, HasPrefixedName {
//@formatter:off
    /** modifiedBy.         */ modifiedBy            ("modifiedBy",            ANNOTATION_PROPERTY),
...
//@formatter:on
  ...
  COREVocabulary(final String localname, final EntityType<?> entityType) {
    this.localName = localname;
    this.prefixedName = NameSpace.CORE.getPrefixName() + ':' + localname;
    this.entityType = entityType;
    this.iri = IRI.create(NameSpace.CORE.toString(), localname);
  }

  private static Stream<COREVocabulary> stream() {
