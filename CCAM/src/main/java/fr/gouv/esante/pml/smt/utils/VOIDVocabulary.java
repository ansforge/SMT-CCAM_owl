...
public enum VOIDVocabulary implements HasShortForm, HasIRI, HasPrefixedName {
//@formatter:off
    /** openSearchDescription.         */ openSearchDescription            ("openSearchDescription",            ANNOTATION_PROPERTY),
    /** rootResource.         */  rootResource          ("rootResource",            ANNOTATION_PROPERTY),
    /** uriLookupEndpoint.      */  uriLookupEndpoint          ("uriLookupEndpoint",            ANNOTATION_PROPERTY),
    /** uriRegexPattern.       */  uriRegexPattern          ("uriRegexPattern",            ANNOTATION_PROPERTY),
...
//@formatter:on
  ...
  VOIDVocabulary(final String localname, final EntityType<?> entityType) {
    this.localName = localname;
    this.prefixedName = Namespaces.DCAT.getPrefixName() + ':' + localname;
    this.entityType = entityType;
    this.iri = IRI.create(Namespaces.DCAT.toString(), localname);
  }

  private static Stream<VOIDVocabulary> stream() {
