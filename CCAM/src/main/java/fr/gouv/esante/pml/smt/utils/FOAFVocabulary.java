...
public enum FOAFVocabulary implements HasShortForm, HasIRI, HasPrefixedName {
//@formatter:off
    /** name.         */ name            ("name",            ANNOTATION_PROPERTY),
    /** homepage.         */ homepage            ("homepage",            ANNOTATION_PROPERTY),
...
//@formatter:on
  ...
  FOAFVocabulary(final String localname, final EntityType<?> entityType) {
    this.localName = localname;
    this.prefixedName = Namespaces.FOAF.getPrefixName() + ':' + localname;
    this.entityType = entityType;
    this.iri = IRI.create(Namespaces.FOAF.toString(), localname);
  }

  private static Stream<FOAFVocabulary> stream() {
