...
public enum XSkosVocabulary implements HasShortForm, HasIRI, HasPrefixedName {
//@formatter:off
    /** exclusionNote.         */ exclusionNote            ("exclusionNote",            ANNOTATION_PROPERTY),
    /** inclusionNote.         */ inclusionNote          ("inclusionNote",            ANNOTATION_PROPERTY),
...
//@formatter:on
  ...
  XSkosVocabulary(final String localname, final EntityType<?> entityType) {
    this.localName = localname;
    this.prefixedName = NameSpace.XKOS.getPrefixName() + ':' + localname;
    this.entityType = entityType;
    this.iri = IRI.create(NameSpace.XKOS.toString(), localname);
  }

  private static Stream<XSkosVocabulary> stream() {
