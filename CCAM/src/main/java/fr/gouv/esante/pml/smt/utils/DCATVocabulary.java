...
public enum DCATVocabulary implements HasShortForm, HasIRI, HasPrefixedName {
//@formatter:off
    /** accessURL.         */ accessURL            ("accessURL",            ANNOTATION_PROPERTY),
    /** mediaType.         */  mediaType          ("mediaType",            ANNOTATION_PROPERTY),
    /** distribution.      */  distribution          ("distribution",            ANNOTATION_PROPERTY),
    /** landingPage.       */  landingPage          ("landingPage",            ANNOTATION_PROPERTY),
    /** theme.             */  theme          ("theme",            ANNOTATION_PROPERTY),
...
//@formatter:on
  ...
  DCATVocabulary(final String localname, final EntityType<?> entityType) {
  ...
  private static Stream<DCATVocabulary> stream() {
