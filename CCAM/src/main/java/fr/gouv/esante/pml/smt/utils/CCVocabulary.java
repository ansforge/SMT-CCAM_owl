...
public enum CCVocabulary implements HasShortForm, HasIRI, HasPrefixedName {
//@formatter:off
    /** useGuidelines.         */ useGuidelines            ("useGuidelines",            ANNOTATION_PROPERTY),
...
//@formatter:on
  ...
  CCVocabulary(final String localname, final EntityType<?> entityType) {
    this.localName = localname;
    this.prefixedName = Namespaces.CC.getPrefixName() + ':' + localname;
    this.entityType = entityType;
    this.iri = IRI.create(Namespaces.CC.toString(), localname);
  }

  private static Stream<CCVocabulary> stream() {
