...
public enum DOORVocabulary implements HasShortForm, HasIRI, HasPrefixedName {
//@formatter:off
    /** comesFromTheSameDomain.         */ comesFromTheSameDomain            ("comesFromTheSameDomain",            ANNOTATION_PROPERTY),
...
//@formatter:on
  ...
  DOORVocabulary(final String localname, final EntityType<?> entityType) {
    this.localName = localname;
    this.prefixedName = NameSpace.DOOR.getPrefixName() + ':' + localname;
    this.entityType = entityType;
    this.iri = IRI.create(NameSpace.DOOR.toString(), localname);
  }

  private static Stream<DOORVocabulary> stream() {
