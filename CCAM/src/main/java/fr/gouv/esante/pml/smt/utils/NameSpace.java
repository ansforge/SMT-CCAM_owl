...
public enum NameSpace {
  ...
  /** The ICD namespace. */
  CCAM("ccam", "http://data.esante.gouv.fr/cnam/ccam/"),
  /** The ICD namespace. */
  ANSICD11("ans-icd11", "http://data.esante.gouv.fr/ans-icd11#"),
  /** The ICD namespace. */
  ADICAP("ans-adicap", "https://data.esante.gouv.fr/ans-adicap#"),
  /** The XKOS namespace. */
