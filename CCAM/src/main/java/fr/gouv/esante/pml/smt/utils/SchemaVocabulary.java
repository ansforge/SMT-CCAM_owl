...
public enum SchemaVocabulary implements HasShortForm, HasIRI, HasPrefixedName {
//@formatter:off
    /** author.         */ author            ("author",            ANNOTATION_PROPERTY),
    /** priceSpecification.         */  priceSpecification          ("priceSpecification",            ANNOTATION_PROPERTY),
    /** price.      */  price          ("price",            ANNOTATION_PROPERTY),
    /** translator.      */  translator          ("translator",            ANNOTATION_PROPERTY),
...
//@formatter:on
  ...
  SchemaVocabulary(final String localname, final EntityType<?> entityType) {
    this.localName = localname;
    this.prefixedName = Namespaces.SCHEMA.getPrefixName() + ':' + localname;
    this.entityType = entityType;
    this.iri = IRI.create(Namespaces.SCHEMA.toString(), localname);
  }

  private static Stream<SchemaVocabulary> stream() {
