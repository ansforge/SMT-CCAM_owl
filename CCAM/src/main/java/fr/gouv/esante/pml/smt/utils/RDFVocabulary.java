...
public enum RDFVocabulary implements HasShortForm, HasIRI, HasPrefixedName {
//@formatter:off
    /** value.         */ value            ("value",            ANNOTATION_PROPERTY),
...
//@formatter:on
  ...
  RDFVocabulary(final String localname, final EntityType<?> entityType) {
    this.localName = localname;
    this.prefixedName = Namespaces.RDF.getPrefixName() + ':' + localname;
    this.entityType = entityType;
    this.iri = IRI.create(Namespaces.RDF.toString(), localname);
  }

  private static Stream<RDFVocabulary> stream() {
