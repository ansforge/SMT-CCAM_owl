...
public enum ADICAPVocabulary implements HasShortForm, HasIRI, HasPrefixedName {
//@formatter:off
    /** dictionaryCode.         */ dictionaryCode          ("dictionaryCode",            ANNOTATION_PROPERTY),
...
//@formatter:on
  ...
  ADICAPVocabulary(final String localname, final EntityType<?> entityType) {
    this.localName = localname;
    this.prefixedName = NameSpace.ADICAP.getPrefixName() + ':' + localname;
    this.entityType = entityType;
    this.iri = IRI.create(NameSpace.ADICAP.toString(), localname);
  }

  private static Stream<ADICAPVocabulary> stream() {
