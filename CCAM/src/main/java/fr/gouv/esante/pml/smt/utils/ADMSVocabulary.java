...
public enum ADMSVocabulary implements HasShortForm, HasIRI, HasPrefixedName {
//@formatter:off
...
//@formatter:on
  ...
  ADMSVocabulary(final String localname, final EntityType<?> entityType) {
    this.localName = localname;
    this.prefixedName = NameSpace.ADMS.getPrefixName() + ':' + localname;
    this.entityType = entityType;
    this.iri = IRI.create(NameSpace.ADMS.toString(), localname);
  }

  private static Stream<ADMSVocabulary> stream() {
