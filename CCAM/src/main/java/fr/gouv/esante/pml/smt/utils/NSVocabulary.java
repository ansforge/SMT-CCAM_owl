...
public enum NSVocabulary implements HasShortForm, HasIRI, HasPrefixedName {
//@formatter:off
    /** complexity.         */ complexity            ("complexity",            ANNOTATION_PROPERTY),
...
//@formatter:on
  ...
  NSVocabulary(final String localname, final EntityType<?> entityType) {
    this.localName = localname;
    this.prefixedName = NameSpace.NS.getPrefixName() + ':' + localname;
    this.entityType = entityType;
    this.iri = IRI.create(NameSpace.NS.toString(), localname);
  }

  private static Stream<NSVocabulary> stream() {
