...
public enum PAVVocabulary implements HasShortForm, HasIRI, HasPrefixedName {
//@formatter:off
    /** curatedBy.         */ curatedBy            ("curatedBy",            ANNOTATION_PROPERTY),
...
//@formatter:on
  ...
  PAVVocabulary(final String localname, final EntityType<?> entityType) {
    this.localName = localname;
    this.prefixedName = NameSpace.PAV.getPrefixName() + ':' + localname;
    this.entityType = entityType;
    this.iri = IRI.create(NameSpace.PAV.toString(), localname);
  }

  private static Stream<PAVVocabulary> stream() {
