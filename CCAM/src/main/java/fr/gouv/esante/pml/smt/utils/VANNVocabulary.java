...
public enum VANNVocabulary implements HasShortForm, HasIRI, HasPrefixedName {
//@formatter:off
    /** changes.         */ changes            ("changes",            ANNOTATION_PROPERTY),
    /** preferredNamespacePrefix.         */ preferredNamespacePrefix            ("preferredNamespacePrefix",            ANNOTATION_PROPERTY),
    /** preferredNamespaceUri.         */ preferredNamespaceUri            ("preferredNamespaceUri",            ANNOTATION_PROPERTY),
...
//@formatter:on
  ...
  VANNVocabulary(final String localname, final EntityType<?> entityType) {
    this.localName = localname;
    this.prefixedName = NameSpace.VANN.getPrefixName() + ':' + localname;
    this.entityType = entityType;
    this.iri = IRI.create(NameSpace.VANN.toString(), localname);
  }

  private static Stream<VANNVocabulary> stream() {
