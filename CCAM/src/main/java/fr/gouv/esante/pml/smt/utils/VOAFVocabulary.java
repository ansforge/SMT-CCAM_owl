...
public enum VOAFVocabulary implements HasShortForm, HasIRI, HasPrefixedName {
//@formatter:off
    /** classNumber.         */ classNumber            ("classNumber",            ANNOTATION_PROPERTY),
    /** hasEquivalencesWith.         */ hasEquivalencesWith            ("hasEquivalencesWith",            ANNOTATION_PROPERTY),
    /** similar.         */ similar            ("similar",            ANNOTATION_PROPERTY),
...
//@formatter:on
  ...
  VOAFVocabulary(final String localname, final EntityType<?> entityType) {
    this.localName = localname;
    this.prefixedName = NameSpace.VOAF.getPrefixName() + ':' + localname;
    this.entityType = entityType;
    this.iri = IRI.create(NameSpace.VOAF.toString(), localname);
  }

  private static Stream<VOAFVocabulary> stream() {
