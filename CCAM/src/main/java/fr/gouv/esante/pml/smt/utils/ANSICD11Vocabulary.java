...
public enum ANSICD11Vocabulary implements HasShortForm, HasIRI, HasPrefixedName {
//@formatter:off
    /** inclusion.         */ inclusion          ("inclusion",            ANNOTATION_PROPERTY),
    /** exclusion.         */ exclusion          ("exclusion",            ANNOTATION_PROPERTY),
    /** indexTerm.         */ indexTerm          ("indexTerm",            ANNOTATION_PROPERTY),
    /** icd10.         	   */ icd10          ("icd10",            ANNOTATION_PROPERTY),
    /** foundationChild.   */ foundationChild    ("foundationChild",            ANNOTATION_PROPERTY),
    /** PostCoordinationScaleInfo.   */ PostCoordinationScaleInfo    ("PostCoordinationScaleInfo",            ANNOTATION_PROPERTY),
    /** PostCoordinationSourceEntity.   */ PostCoordinationSourceEntity    ("PostCoordinationSourceEntity",            ANNOTATION_PROPERTY),
...
//@formatter:on
  ...
  ANSICD11Vocabulary(final String localname, final EntityType<?> entityType) {
    this.localName = localname;
    this.prefixedName = NameSpace.ANSICD11.getPrefixName() + ':' + localname;
    this.entityType = entityType;
    this.iri = IRI.create(NameSpace.ANSICD11.toString(), localname);
  }

  private static Stream<ANSICD11Vocabulary> stream() {
